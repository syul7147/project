...
<aside class="border-end fixed" style="width:200px;">	
	<div class="nav-item " style="text-align:Left">
		...
		<ul class="d-flex mList">
			<li><a class="nav-link" href ="<c:url value='/user/login.do'/>">LOGIN &nbsp</a></li><li><a class="nav-link" href ="<c:url value='/user/join.do'/>">JOIN &nbsp</a></li><li><a class="nav-link" href ="<c:url value='/user/myPage.do'/>">MY PAGE</a></li>
			<li></li>
			<li></li>
		</ul>
	</div>
	...
	<c:if test="${cDtos.size()!=0}">
		<c:forEach var="ps" items="${pspec}">
			<li>
				<a href="specList.do?pspec=${ps.name()}">${ps.name()}</a>
			</li>
		</c:forEach>
