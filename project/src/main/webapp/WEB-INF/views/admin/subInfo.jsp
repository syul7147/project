...
<div class="text-center mt-3">
  <h4>카테고리 수정</h4>
  <form action="<c:url value="submodify.do"/>" method="post">
	  <div class="form-group">
	    <label for="c_code">번호</label>        
	  	<input class="form-control" type="text" id="c_num" 
	  		name="c_num" value="${sDto.c_num}" readonly>
	  </div> 
	  <div class="form-group">
	  ...
	  <div class="form-group">
	  	...
	  	<input class="form-control" type="text" id="c_subname" 
	  		name="c_subname" value="${sDto.c_subname}">      
	     </div>	     
	     <div class="text-center mt-3">
...
/* 	$("#btn-list").click(()=>{
	...
	function remove(){
		location.href="<c:url value='/admin/subremove.do?c_num=${sDto.c_num}'/>";
	};
</script>
</body>
</html>
